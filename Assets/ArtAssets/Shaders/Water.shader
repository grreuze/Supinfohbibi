    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 normalLocal = (node_9234*(((node_3295.rgb*node_9142.rgb)+_Remap)*3.0+-2.0));
