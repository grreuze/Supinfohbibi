...
////// Emissive:
                ...
                float3 emissive = lerp(_Texture_var.rgb,_Fade.rgb,floor((distance(i.posWorld.rgb,_WorldSpaceCameraPos)/_Dist) * _Posterize) / (_Posterize - 1));
