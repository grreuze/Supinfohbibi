    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                v.vertex.xyz += ((saturate(sin((((node_8487.g*_Wave_Speed_U)+mul(unity_ObjectToWorld, v.vertex).rgb.r)*_Wave_Quantity_U)))*_Wave_Intensity_U*v.normal)+(saturate(sin((((node_8487.g*_Wave_Speed_V)+mul(unity_ObjectToWorld, v.vertex).rgb.g)*_Wave_Quantity_V)))*_Wave_Intensity_V*v.normal));
...
////// Emissive:
                ...
                float3 emissive = lerp(lerp(_Color1.rgb,_Color2.rgb,_alpha_var.rgb),_Fade.rgb,floor((distance(i.posWorld.rgb,_WorldSpaceCameraPos)/_Dist) * _Posterize) / (_Posterize - 1));
